"Resource/UI/FullLoadoutPanel.res" //adjusted for 4:3
{
	"ImageBG"
	{
	...
	"class_loadout_panel"
	{
		...
		"item_xpos_offcenter_a"	"-35" //xpos left item row
		"item_xpos_offcenter_b"	"110" //xpos right cosmetic row
	...
	"CharacterLoadoutButton" //toolbox icon next to taunt button
	{
		...
		"labelText"		""
		"xpos"			"c-65" //xpos for item, taunt, red and blue button
		"ypos"			"60"
		"zpos"			"2"
		"wide"			"25"
		"tall"			"25"
